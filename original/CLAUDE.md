...
Original game script files and documentation (read-only reference)

This is a unit of the **LoFP** project.

## Sibling Units

- **Engine** (`engine`) — Go backend: script parser, game engine, command interpreter, MongoDB persistence
